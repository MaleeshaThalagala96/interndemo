...
//
//    private static final Logger logger = (Logger) LoggerFactory.getLogger(EditService.class);
//
//    public PagedResponse<UserProfile> getAllPolls(UserPrincipal currentUser, int page, int size) {
//        validatePageNumberAndSize(page, size);
//
//        // Retrieve Polls
//        Pageable pageable = PageRequest.of(page, size, Sort.Direction.DESC, "createdAt");
//        Page<User> polls = userRepository.findAll(pageable);
//
...
//        List<String> username = polls.map(Poll::getId).getContent();
...
//    }
//
//    public EditResponse editProfile(String username, EditRequest editRequest, UserPrincipal currentUser) {
